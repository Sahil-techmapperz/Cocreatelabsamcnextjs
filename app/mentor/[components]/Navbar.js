...
const Navbar = () => {
    ...
    const menuItems = [
        { name: "Dashboard", path: "/mentor/dashbord", imgSrc: dashboardImg, altText: "Dashboard" },
        { name: "Session", path: "/mentor/session", imgSrc: openBook, altText: "Session" },
        { name: "Calendar", path: "/mentor/calender", imgSrc: planning, altText: "Session Calendar" },
        { name: "Notice Board", path: "/mentor/noticeboard", imgSrc: NoticeImage, altText: "Notice Board" },
        { name: "Messages", path: "/mentor/chat", imgSrc: messageImg, altText: "Messages" },
        { name: "My Account", path: "/mentor/account", imgSrc: contact, altText: "My Account" },
        { name: "My withdrawls", path: "/mentor/withdrawls", imgSrc: contact, altText: "withdrawls" }
    ];
