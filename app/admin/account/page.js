...
import { FaInfoCircle,FaBoxTissue } from "react-icons/fa";
...
const gridItems = [
    { icon: <ImProfile/>, heading: 'Profile', description: 'Personal details and how we can reach you', link: "/admin/profile" },
    { icon: <FaInfoCircle/>, heading: 'Personal info', description: 'Provide personal details and how we can reach you', link: "/admin/personalInfo" },
    { icon: <GrShieldSecurity/>, heading: 'Login & security', description: 'Update your password and secure your account', link: "/admin/security" },
    { icon: <FaBoxTissue/>, heading: 'Reported Issue', description: 'User reported issue , sent reply and edit status', link: "/admin/wallet" },
    { icon: <IoNotifications/>, heading: 'Notifications', description: 'Choose notification preferences and how you want to be contacted', link: "/admin/noticeboard" },
