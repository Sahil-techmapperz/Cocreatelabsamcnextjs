...
const Signin = () => {
  ...
  return (
    <div className="flex max-sm:flex-col text-black justify-around items-center min-h-screen bg-gray-50">
      <ToastContainer />
      ...
      >
        ...
        <p className="text-lg font-semibold text-center text-black mb-6">Sign In As Admin</p>
